# benchmark/models/qwen3_coder.py
...
class Qwen3Coder(BaseModel):
    ...
    def __init__(self, device: str = None):
        ...
        self.model     = AutoModel.from_pretrained(self.MODEL_ID, torch_dtype="auto", device_map="cuda").to(self.device)
        self.model.eval()
