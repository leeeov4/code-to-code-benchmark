...
class SPTCode(BaseModel):

    MODEL_ID   = "claudios/sptcode"
    MODEL_NAME = "sptcode"
    MAX_LENGTH = 512
    ...
    def __init__(self, device: str = None):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(self.MODEL_ID, subfolder="code_tokenizer_fast")
